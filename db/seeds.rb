...
good6 = Good.create!(order: order9, string_id: '8gek4f', location: shop8, staff: staff16, last_action: check_action_issue, rfid_tag: '0000 0000 0000 0000 0000 0003', weight: 2.7, fragile: false, flammable: false, goods_photo: @goods_photo)

CheckLog.create!(time: Time.now + 1, good: good1, location: specify_address3, check_action: check_action_receive, staff: staff3)
CheckLog.create!(time: Time.now + 2, good: good1, location: car3, check_action: check_action_load, staff: staff3)
CheckLog.create!(time: Time.now + 3, good: good1, location: car3, check_action: check_action_unload, staff: staff3)
CheckLog.create!(time: Time.now + 4, good: good1, location: store1, check_action: check_action_warehouse, staff: staff6)
CheckLog.create!(time: Time.now + 5, good: good1, location: store1, check_action: check_action_inspect, staff: staff6)
CheckLog.create!(time: Time.now + 1, good: good2, location: specify_address3, check_action: check_action_receive, staff: staff3)
CheckLog.create!(time: Time.now + 2, good: good2, location: car3, check_action: check_action_load, staff: staff3)
CheckLog.create!(time: Time.now + 3, good: good2, location: car3, check_action: check_action_unload, staff: staff3)
CheckLog.create!(time: Time.now + 4, good: good2, location: store1, check_action: check_action_warehouse, staff: staff6)
CheckLog.create!(time: Time.now + 5, good: good2, location: store1, check_action: check_action_inspect, staff: staff6)
CheckLog.create!(time: Time.now + 1, good: good3, location: shop4, check_action: check_action_receive, staff: staff12)
CheckLog.create!(time: Time.now + 1, good: good4, location: shop2, check_action: check_action_receive, staff: staff10)
CheckLog.create!(time: Time.now + 2, good: good4, location: shop2, check_action: check_action_leave, staff: staff10)
CheckLog.create!(time: Time.now + 3, good: good4, location: car3, check_action: check_action_load, staff: staff3)
CheckLog.create!(time: Time.now + 4, good: good4, location: car3, check_action: check_action_unload, staff: staff3)
CheckLog.create!(time: Time.now + 5, good: good4, location: store1, check_action: check_action_warehouse, staff: staff6)
CheckLog.create!(time: Time.now + 6, good: good4, location: store1, check_action: check_action_inspect, staff: staff6)
CheckLog.create!(time: Time.now + 7, good: good4, location: store1, check_action: check_action_inspect, staff: staff6)
CheckLog.create!(time: Time.now + 8, good: good4, location: store1, check_action: check_action_leave, staff: staff6)
CheckLog.create!(time: Time.now + 9, good: good4, location: car2, check_action: check_action_load, staff: staff2)
CheckLog.create!(time: Time.now + 10, good: good4, location: car2, check_action: check_action_unload, staff: staff2)
CheckLog.create!(time: Time.now + 11, good: good4, location: store3, check_action: check_action_warehouse, staff: staff8)
CheckLog.create!(time: Time.now + 12, good: good4, location: store3, check_action: check_action_inspect, staff: staff8)
CheckLog.create!(time: Time.now + 13, good: good4, location: store3, check_action: check_action_leave, staff: staff8)
CheckLog.create!(time: Time.now + 14, good: good4, location: car5, check_action: check_action_load, staff: staff5)
CheckLog.create!(time: Time.now + 15, good: good4, location: car5, check_action: check_action_unload, staff: staff5)
CheckLog.create!(time: Time.now + 16, good: good4, location: specify_address5, check_action: check_action_receive, staff: staff5)
CheckLog.create!(time: Time.now + 1, good: good5, location: specify_address9, check_action: check_action_receive, staff: staff5)
CheckLog.create!(time: Time.now + 2, good: good5, location: car5, check_action: check_action_load, staff: staff5)
CheckLog.create!(time: Time.now + 3, good: good5, location: car5, check_action: check_action_unload, staff: staff5)
CheckLog.create!(time: Time.now + 4, good: good5, location: store3, check_action: check_action_warehouse, staff: staff8)
CheckLog.create!(time: Time.now + 5, good: good5, location: store3, check_action: check_action_inspect, staff: staff8)
CheckLog.create!(time: Time.now + 6, good: good5, location: store3, check_action: check_action_leave, staff: staff8)
CheckLog.create!(time: Time.now + 7, good: good5, location: car5, check_action: check_action_load, staff: staff5)
CheckLog.create!(time: Time.now + 8, good: good5, location: car5, check_action: check_action_unload, staff: staff5)
CheckLog.create!(time: Time.now + 9, good: good5, location: shop8, check_action: check_action_warehouse, staff: staff16)
CheckLog.create!(time: Time.now + 10, good: good5, location: shop8, check_action: check_action_issue, staff: staff16)
CheckLog.create!(time: Time.now + 1, good: good6, location: specify_address9, check_action: check_action_receive, staff: staff5)
CheckLog.create!(time: Time.now + 2, good: good6, location: car5, check_action: check_action_load, staff: staff5)
CheckLog.create!(time: Time.now + 3, good: good6, location: car5, check_action: check_action_unload, staff: staff5)
CheckLog.create!(time: Time.now + 4, good: good6, location: store3, check_action: check_action_warehouse, staff: staff8)
CheckLog.create!(time: Time.now + 5, good: good6, location: store3, check_action: check_action_inspect, staff: staff8)
CheckLog.create!(time: Time.now + 6, good: good6, location: store3, check_action: check_action_leave, staff: staff8)
CheckLog.create!(time: Time.now + 7, good: good6, location: car5, check_action: check_action_load, staff: staff5)
CheckLog.create!(time: Time.now + 8, good: good6, location: car5, check_action: check_action_unload, staff: staff5)
CheckLog.create!(time: Time.now + 9, good: good6, location: shop8, check_action: check_action_warehouse, staff: staff16)
CheckLog.create!(time: Time.now + 10, good: good6, location: shop8, check_action: check_action_issue, staff: staff16)
