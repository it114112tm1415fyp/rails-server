class RegisteredUser < ActiveRecord::Base
	...
	def get_receive_orders
		receive_orders.collect { |x1| {id: x1.id, sender: {id: x1.sender.id, name: x1.sender.name}, receiver: {id: x1.receiver.id, name: x1.receiver.name}, departure: {type: x1.departure.class.to_s, id: x1.departure.id, short_name: x1.departure.short_name, long_name: x1.departure.long_name, region: {id: x1.departure.region.id, name: x1.departure.region.name}}, destination: {type: x1.destination.class.to_s, id: x1.destination.id, short_name: x1.destination.short_name, long_name: x1.destination.long_name, region: {id: x1.destination.region.id, name: x1.destination.region.name}}, goods_number: x1.goods_number, goods: x1.goods.collect { |x2| x2.string_id }, state: x1.order_state.name, update_time: x1.updated_at, order_time: x1.created_at} }
	end
	def get_send_orders
		send_orders.collect { |x1| {id: x1.id, sender: {id: x1.sender.id, name: x1.sender.name}, receiver: {id: x1.receiver.id, name: x1.receiver.name}, departure: {type: x1.departure.class.to_s, id: x1.departure.id, short_name: x1.departure.short_name, long_name: x1.departure.long_name, region: {id: x1.departure.region.id, name: x1.departure.region.name}}, destination: {type: x1.destination.class.to_s, id: x1.destination.id, short_name: x1.destination.short_name, long_name: x1.destination.long_name, region: {id: x1.destination.region.id, name: x1.destination.region.name}}, goods_number: x1.goods_number, goods: x1.goods.collect { |x2| x2.string_id }, state: x1.order_state.name, update_time: x1.updated_at, order_time: x1.created_at} }
	end
